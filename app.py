...
app.config['MAIL_USERNAME'] = 'alanimmanuel768@gmail.com'   # CHANGE
app.config['MAIL_PASSWORD'] = 'warqvttiqhddftln'      # CHANGE
...
def admin_reminders():
    ...
    for record in borrows:
        if tomorrow in record.due_date:
            due_tomorrow.append(record)
...
def borrow_book(id):
    ...
    try:
        msg = Message(
            ...
            recipients=[student_email, app.config['MAIL_USERNAME']]
        )
